    ...
    return (
        <div>
            <div className="container mx-auto">
                <h1 className='text-3xl font-semibold' style={{ color: '#0B785C' }}>Technologies I Use</h1>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center mt-4">
                    ...
                    <FramermotionOriginalWordmark size={70} className="mx-auto" />
                    ...
                    <ExpressOriginalWordmark size={70} className="mx-auto" />
                </div>
            </div>
        </div>
    )
